...
load_dotenv()
        ...
        return self._make_request(endpoint, params)t json
from datetime import datetime, timedelta
from typing import Dict, List, Optional, Union
from dotenv import load_dotenv
...
class CWAClient:
    ...
    def get_local_earthquake_report(self, language: str = 'zh') -> Dict:
        """
        取得小區域有感地震報告
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"取得 {len(earthquake_data.get('records', {}).get('earthquake', []))} 筆地震資料")
